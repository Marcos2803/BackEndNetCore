...
namespace fourfit.sistema_gestao.Migrations
{
    ...
    [Migration("20241014212254_DbCtFourFitUser")]
    partial class DbCtFourFitUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fourfit.sistema_gestao.Domain.Entities.Alunos.Parcelas", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ParcelaMensalidades", (string)null);
                });
            ...
            modelBuilder.Entity("fourfit.sistema_gestao.Domain.Entities.Alunos.TipoPlano", b =>
                {
                    ...
                    b.Property<string>("StatusPlanos")
                        .IsRequired()
                        .HasColumnType("varchar(10)");
            ...
            modelBuilder.Entity("fourfit.sistema_gestao.Domain.Entities.Alunos.Parcelas", b =>
                {
                    b.HasOne("fourfit.sistema_gestao.Domain.Entities.Financas.FormaPagamento", null)
                        .WithMany("ParcelaMensalidades")
                        .HasForeignKey("FormaPagamentoId");

                    b.HasOne("fourfit.sistema_gestao.Domain.Entities.Alunos.Mensalidades", "Mensalidades")
                        .WithMany("ParcelaMensalidades")
            ...
            modelBuilder.Entity("fourfit.sistema_gestao.Domain.Entities.Alunos.Mensalidades", b =>
                {
                    b.Navigation("ParcelaMensalidades");
                });
